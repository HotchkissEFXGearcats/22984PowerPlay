...
public class TestingWindMc extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        waitForStart();
        autoLift(1);
        goAngle(0.25, 270, 700);
        sleep(4100);
        outtake();

        goAngle(0.25, 270, 300);
        ...
        stopDrive();
        autoLower(1); // Lower the lift height
    ...
    public void autoLower(double power) {
        int min = 20;
        // wait for 2 seconds
